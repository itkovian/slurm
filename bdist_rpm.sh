...
elif grep "release 9.8" /etc/redhat-release; then
    sudo yum install -y ucx-devel-1.13.1-2.el9.x86_64 "pmix-devel >= 3.2.3" numactl-devel hwloc-devel-2.4.1-5.el9.x86_64
else
